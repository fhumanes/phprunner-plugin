...
// MIB --------------------------------------------------------------------------------
		$('ul').each(function() { $(this).css('display', ''); });
		$('ol').each(function() { $(this).css('display', ''); });
		$('li').each(function() { $(this).css('display', ''); });
		$(".colapsado").each(function() { $(this).css('display', 'none'); });
		$(".expandido").each(function() { $(this).css('display', ''); });
// ------------------------------------------------------------------------------------
