...
(function($) {
    ...
    function getSelectedAsText(elemList,opts) { 
        ...
        if(opts.listCount == 0){
            ...
            $(".gentleselect-label").removeClass("hasSelection");
            return opts.noDataMessage;
        }
        ...
        $(".gentleselect-label").addClass("hasSelection");
    ...
    var methods = {
        init : function(options) {
            ...
            label_text = getSelectedAsText(this.find(":selected[value!='']"), o);
            $(".gentleselect-label").remove();
           
            var label = $("<span class='gentleselect-label btn btn-default'>" + label_text + "</span>")
                .insertBefore(this)
            ...
            // build dialog box
            $(this).find(".gentleselect-dialog").remove();
            ...
            if (defined(o.columns) || defined(o.rows)) {
                ...
                for (var i = 0; i < (rows * cols) - elemCount; i++) {
                    ...
                    $("<li style='float:left' class='gentleselect-dummy'><span>&nbsp;</span></li>").width(actualWidth).appendTo(ul);
                }
