...
!function($) {
    ...
    Timepicker.prototype = {
        ...
        , init: function () {
            if (this.$element.parent().hasClass('bootstrap-input-append')) {
                this.$element.parent('.bootstrap-input-append').find('.bootstrap-add-on').on('click', $.proxy(this.showWidget, this));
                this.$element.on({
